...
17. The production application is launched through the repository runner.
18. The live dashboard is updated from repository heartbeat and manifest artifacts.
19. Final artifacts are printed and the notebook exits cleanly.
